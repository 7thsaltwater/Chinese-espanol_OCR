...
if __name__ == '__main__':
    ...
    parser.add_argument("--dict_file_path", help="字典文件位置", default="D:/ocr/chinese_ocr-master/chinese_ocr-master/train/char_std_5996.txt")
    ...
    parser.add_argument("--densenet_weight_path", help="densenet模型权重文件位置",
                        default="D:/ocr/text-detection-ocr-master1/text-detection-ocr-master1/dlocr/weights/weights-densent-16.hdf5")
