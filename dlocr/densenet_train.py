...
if __name__ == '__main__':
    ...
    parser.add_argument("-bs", "--batch_size", help="小批量处理大小", default=32, type=int)
    parser.add_argument("--epochs", help="迭代数", default=20, type=int)
    parser.add_argument("--gpus", help="gpu的数量", default=1, type=int)
    parser.add_argument("--images_dir", help="图像位置", default="D:/ocr/chinese_ocr-master/chinese_ocr-master/train/espanol14")
    parser.add_argument("--dict_file_path", help="字典文件位置",
                        default="D:/ocr/chinese_ocr-master/chinese_ocr-master/train/char_std_5996.txt")
    parser.add_argument("--train_file_path", help="训练文件位置",
                        default="D:/ocr/chinese_ocr-master/chinese_ocr-master/train/data_train14.txt")
    parser.add_argument("--test_file_path", help="测试文件位置",
                        default="D:/ocr/chinese_ocr-master/chinese_ocr-master/train/data_test14.txt")
    ...
    parser.add_argument("--weights_file_path", help="模型初始权重文件位置",
                        default="D:/ocr/text-detection-ocr-master1/text-detection-ocr-master1/dlocr/pretrain/weights-densent-06.hdf5")
    #parser.add_argument("--weights_file_path", help="模型初始权重文件位置",
    #                    default=None)
